...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mnrce_admin_emp_relatives', function (Blueprint $table) {
            $table->id();
            $table->date('edate');
            ...
            $table->string('relstatus');                    
            $table->string('relnic')->nullable();                    
            $table->date('reldob');
    ...
    {
        Schema::dropIfExists('mnrce_admin_emp_relatives');
    }
};
