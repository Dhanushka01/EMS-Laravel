...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mnrce_admin_emp_acd_profis', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('pfrom')->nullable();
            $table->date('pto')->nullable();
    ...
    {
        Schema::dropIfExists('mnrce_admin_emp_acd_profis');
    }
};
