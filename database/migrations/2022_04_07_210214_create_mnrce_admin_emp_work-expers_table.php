...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mnrce_admin_emp_work_expers', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('epf_id');

            $table->string('post');
            $table->string('institute');
            $table->date('wfrom')->nullable();
            $table->date('wto')->nullable();
    ...
    {
        Schema::dropIfExists('mnrce_admin_emp_work_expers');
    }
};
