...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mnrce_admin_emp_emer_contacts', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('epf_id');

            $table->string('conname');
            $table->string('conmobile');
            $table->text('conaddress');
    ...
    {
        Schema::dropIfExists('mnrce_admin_emp_emer_contacts');
    }
};
