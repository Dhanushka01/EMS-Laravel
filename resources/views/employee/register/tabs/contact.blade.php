<div class="card-body">
	<div class="row">
      ...
      class="form-control" >
    	...
    	<select id="a6" class="form-control select2"  name="a6" placeholder="District" >
    ...
    <div class="form-group col-md-12">
      <label  for="telephone">Current Residence Address   <span style="color: red;" class="required"></span>
      </label>
    ...
    <div class="form-group col-md-4">
      <label  for="telephone">Telephone No: <span style="color: red;" class="required">*</span>
      </label>
